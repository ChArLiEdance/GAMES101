...
#Inputs: None
#Outputs: None
#escriptions: store the argument registers, frame pointer, and
        #     return address so that newly spawned thread begin 
        #     execution at their designed entry points and call
        #     running_thread_exit when they return
#Side Effects: None
